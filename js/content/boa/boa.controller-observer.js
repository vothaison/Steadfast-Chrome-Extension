...
V.modules.create({
    ...
    urlRegexes: [V.BOA.UrlRegex.AllPages],
    runNow: true,
    alwaysOn: true,
    context: {
    ...
    execute: function (options) {
        ...
        if (!options.enableSneakyToolBOA) return;

        $('body').attr('data-sf_controller_name_lookup_function', options.controllerLookupFunctionBOA);
        V.lib.loadJsFile("chrome-extension://" + chrome.runtime.id + "/js/content/util/controller-observer.in-page.js", "js");
        V.lib.loadCssFile("chrome-extension://" + chrome.runtime.id + "/css/content/boa/boa.css", "css");
